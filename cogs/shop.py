...
class shop(commands.Cog):
    ...
    async def __rshop(self, ctx):
        ...
        embed=discord.Embed(title="Магазин ролей", description="Нажми на реакцию, чтобы приобрести роль", color=0x52bdff)
                    ...
                    if member is not None:
                        ...
                        if bal >= cost:
                            if role1 in payload.member.roles:
                                ...
                                msg = await member.send(f'Вы уверены что хотите приобрести ``{role1}``?\nНажми на **галочку**, чтобы **подтверидть** действие.', delete_after = 31)
                                ...
                                try:
                                    ...
                                    bal = self.cursor.fetchone()[0]
                                    if bal >= cost:
                                        self.cursor.execute("UPDATE users SET balance = balance - {} WHERE id = {}".format(cost, member.id))
                                        self.conn.commit()
                            ...
                            await self.client.http.remove_reaction(payload.channel_id, payload.message_id, '1️⃣', payload.user_id)
                ...
                if role1 is not None:
                    ...
                    if member is not None:
                        ...
                        if bal >= cost:
                            ...
                            await self.client.http.remove_reaction(payload.channel_id, payload.message_id, '2️⃣', payload.user_id)
                            await member.send('У вас недостаточно средств для покупки данной роли!', delete_after = 30)
                    else:
                        pass
                ...
                if role1 is not None:
                    ...
                    if member is not None:
                        ...
                        if bal >= cost:
                            ...
                            await self.client.http.remove_reaction(payload.channel_id, payload.message_id, '3️⃣', payload.user_id)
                            await member.send('У вас недостаточно средств для покупки данной роли!', delete_after = 30)
                    else:
                        pass
                ...
                if role1 is not None:
                    ...
                    if member is not None:
                        ...
                        if bal >= cost:
                            ...
                            await self.client.http.remove_reaction(payload.channel_id, payload.message_id, '4️⃣', payload.user_id)
                            await member.send('У вас недостаточно средств для покупки данной роли!', delete_after = 30)
                    else:
                        pass
                ...
                if role1 is not None:
                    ...
                    if member is not None:
                        ...
                        if bal >= cost:
                            ...
                            await self.client.http.remove_reaction(payload.channel_id, payload.message_id, '5️⃣', payload.user_id)
                            await member.send('У вас недостаточно средств для покупки данной роли!', delete_after = 30)
                    else:
                        pass
                ...
                if role1 is not None:
                    ...
                    if member is not None:
                        ...
                        if bal >= cost:
                            ...
                            await self.client.http.remove_reaction(payload.channel_id, payload.message_id, '6️⃣', payload.user_id)
                            await member.send('У вас недостаточно средств для покупки данной роли!', delete_after = 30)
                    else:
                        pass
                ...
                if role1 is not None:
                    ...
                    if member is not None:
                        ...
                        if bal >= cost:
                            ...
                            await self.client.http.remove_reaction(payload.channel_id, payload.message_id, '7️⃣', payload.user_id)
                            await member.send('У вас недостаточно средств для покупки данной роли!', delete_after = 30)
                    else:
                        pass
                ...
                if role1 is not None:
                    ...
                    if member is not None:
                        ...
                        if bal >= cost:
                            ...
                            await self.client.http.remove_reaction(payload.channel_id, payload.message_id, '8️⃣', payload.user_id)
                            await member.send('У вас недостаточно средств для покупки данной роли!', delete_after = 30)
                    else:
                        pass
                ...
                if role1 is not None:
                    ...
                    if member is not None:
                        ...
                        if bal >= cost:
                            ...
                            await self.client.http.remove_reaction(payload.channel_id, payload.message_id, '9️⃣', payload.user_id)
                            await member.send('У вас недостаточно средств для покупки данной роли!', delete_after = 30)
                    else:
                        pass
                ...
                if role1 is not None:
                    ...
                    if member is not None:
                        ...
                        if bal >= cost:
                            ...
                            await self.client.http.remove_reaction(payload.channel_id, payload.message_id, '🔟', payload.user_id)
                            await member.send('У вас недостаточно средств для покупки данной роли!', delete_after = 30)
                    else:
                        pass
